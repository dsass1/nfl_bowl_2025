...
predictions <- read_rds(here("../input/results/predictions.rds"))
...
Figure \@ref(fig:fig-run) illustrates a play where the ball carrier rushes to the left of the leftmost offensive lineman. However, the data provided misclassified this play as "inside-left," which corresponds to "middle" under this definition.
...
knitr::include_graphics("https://github.com/dsass1/nfl_bowl_2025/blob/main/images/03_run_gap.png?raw=true")
...
knitr::include_graphics("https://github.com/dsass1/nfl_bowl_2025/blob/main/images/02_run_gap.png?raw=true")
